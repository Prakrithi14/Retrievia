    ...
    <Box sx={{ p: 4, minHeight: "100vh", background: "#f4f6f8" }}>
      ...
      >
        <Typography sx={{ fontSize: "14px", color: "#92400e" }}>
          <strong>Please note:</strong> Only the image with the location found is available.
          If you think it’s yours, provide details like color, size, and contents
            ...
            >
              ...
              <CardContent>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}>
                  <Chip
                    label={idata.status === "claimed" ? "Claimed" : "Available"}
                    color={idata.status === "claimed" ? "success" : "warning"}
                    size="small"
                  />
                </Box>
              ...
              <CardActions>
                <Button
                  ...
                  variant="contained"
                  color="success"
                  disabled={idata.status === "claimed"}   // 🔥 important
                  onClick={() => navigate(`/item/${idata._id}`)}
                >
                  {idata.status === "claimed" ? "Already Claimed" : "View"}
                </Button>
              </CardActions>
